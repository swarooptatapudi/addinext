...
export default function ASEPAOrderForm(_: CranialOrderFormProps) {
  ...
  const [getASPEstimate] = useGetASEPAEstimateMutation();
  const [createASPOrder] = useCreateASEPAOrderMutation();
        ...
        {({
          ...
          type CreateOk =
            ...
            message: {
              ...
              addishield_epipro_active_order_id?: string;
            };
          }
            | {
            status: string;
          ...
          function normalizeCreateResponse(res: unknown) {
            ...
            aspOrderId =
              msgObj?.addishield_epipro_active_order_id ??
              obj?.addishield_epipro_active_order_id ??
              obj?.data?.addishield_epipro_active_order_id;
