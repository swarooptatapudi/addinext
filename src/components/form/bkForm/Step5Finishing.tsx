...
import { BookmarkIcon, Check, Loader, X } from 'lucide-react';
...
//             </div>
//             <Button 
//               className="w-[380px] mt-16 py-6 bg-gradient-to-r bg-primary hover:from-blue-600 hover:to-blue-700 text-white font-semibold shadow-md transition-all"
//               onClick={handleEstimateClick}
//               disabled={isEstimating}
//             >
//               {isEstimating ? 'Estimating...' : 
...
//               <div>
//                 <span className="font-medium text-gray-700">Design : </span>
//                 <span className="text-gray-600"> ₹{estimateData.apiResponse.design}</span>
//               </div>
//             </li>
//           )}
...
//               <div>
//                 <span className="font-medium text-gray-700">Print : </span>
//                 <span className="text-gray-600"> ₹{estimateData.apiResponse.print}</span>
//               </div>
//             </li>
//               )}
//               </>
...
//           {/* Latices Cost - Only show if applicable */}
//           {isAddiEase && estimateData.laticess === 'Yes' && showLaticesField && estimateData.apiResponse.laticess > 0 && (
//             <li className="flex items-start gap-2">
//               <div className={`w-1.5 h-1.5 mt-2 rounded-full flex-shrink-0 ${
//                 isEstimateStale ? 'bg-purple-800' : 'bg-purple-800'
...
//               <div>
//                 <span className="font-medium text-gray-700">Latices : </span>
//                 <span className="text-gray-600"> ₹{estimateData.apiResponse.laticess}</span>
//               </div>
//             </li>
//           )}
...
//               <div>
//                 <span className="font-medium text-gray-700">Finish : </span>
//                 <span className="text-gray-600"> ₹{estimateData.apiResponse.finish}</span>
//               </div>
//             </li>
//           )}
...
//             <div>
//               <span className="font-medium text-gray-700">Subtotal: </span>
//               <span className="text-gray-600"> ₹{estimateData.apiResponse.estimate_price}</span>
//             </div>
//           </li>
...
//               <div>
//                 <span className="font-medium text-gray-700">Additional Discount : </span>
//                 <span className="text-gray-600"> ₹{estimateData.apiResponse.additional_discount}</span>
//               </div>
//             </li>
//           )}
...
//               <div>
//                 <span className="font-medium text-gray-700">GST : </span>
//                 <span className="text-gray-600"> ₹{estimateData.apiResponse.gst}</span>
//               </div>
//             </li>
//           )}
...
//    // Auto-validate coupon after 3 seconds of inactivity when length >= 5
//    useEffect(() => {
//     const timer = setTimeout(() => {
...
//     setIsValidatingCoupon(true);
//     try {
//       console.log('Sending coupon:', { coupon_code: couponCode });
//       // const response = await validateCoupon().unwrap();
//       const response = await validateCoupon({ coupon_code: couponCode }).unwrap();
//       console.log("$$$$",response);
...
//                       : ''
//                   } ${
//                     couponData ? 'border-green-200' : ''
//                   }`}
//                 />
//                 <div className="absolute right-3 top-1/2 transform -translate-y-1/2">
//                   {isValidatingCoupon ? (
//                     <Loader className="h-4 w-4 animate-spin mr-15" />
//                   ) : couponCode.length >= 5 ? (
//                     couponData ? (
//                       <Check className="h-5 w-5 text-green-500 mr-15" />
//                     ) : (
//                       <X className="h-5 w-5 text-red-500  mr-15" />
//                     )
//                   ) : null}
//                 </div>
//               </div>
...
//                       Valid until {new Date(couponData.valid_upto).toLocaleDateString()}
//                     </span>
//                   )}
//                 </div>
//               )}
...
//               <ul className="text-sm space-y-2.5">
//                 <div className="space-y-3 text-sm">
//                     {values.Design_by !=='Self' && values.Print_by !=='Selft'&&(
//                   <li className="flex items-start gap-2">
//                     <div className={`w-1.5 h-1.5 mt-2 rounded-full flex-shrink-0 ${
...
//                       }`}></div>
//                       <div>
//                         <span className="font-medium text-gray-700">Finish Pricdde : </span>
//                         <span className="text-gray-600"> ₹{estimateData.apiResponse.finish.toLocaleString()}</span>
//                       </div>
//                     </li>
//                   )}
...
//                       />
//                       <Label htmlFor="enable-submit" className="text-sm font-medium leading-none ml-1">
//                       Rajiv to give terms and conditions
//                       </Label>
//                     </div>
//                   </div>
//                 )}
